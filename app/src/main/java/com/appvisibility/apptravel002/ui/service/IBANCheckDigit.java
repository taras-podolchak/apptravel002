...
import com.appvisibility.apptravel002.ui.controller.interfaces.CheckDigit;
...
public final class IBANCheckDigit implements CheckDigit, Serializable {
     ...
     * @throws Exception if an error occurs calculating
     * the check digit for the specified code
     */
    @Override
    public String calculate(String code) throws Exception {
        if (code == null || code.length() < MIN_CODE_LEN) {
            throw new Exception("Invalid Code length=" + (code == null ? 0 : code.length()));
        }
